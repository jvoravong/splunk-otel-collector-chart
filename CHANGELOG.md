...
This Splunk OpenTelemetry Collector for Kubernetes release adopts the [Splunk OpenTelemetry Collector vv0.95.0](https://github.com/signalfx/splunk-otel-collector/releases/tag/vv0.95.0).
