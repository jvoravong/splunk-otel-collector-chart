...
- Render actions fail when non Helm values yamls are present in the examples directory ([#686](https://github.com/signalfx/splunk-otel-collector-chart/pull/686)
